...
struct DifficultMode {
    ...
    TableLL* TableObject;       //table data structure
    ...
    DifficultMode(int, int, int, int, Player, int, Player *, Player *, TableLL *, int); //game mode constructor
    ~DifficultMode();           //game mode destructor
    ...
    void displayCellValueAt(int, int, int, int); //display the cell's data at the given position
    void cleanTableDataAtRow(int);               //clean all the cell's data at the given row
    void displayTableDataAtRow(int);             //display all the cell's data at the given row
